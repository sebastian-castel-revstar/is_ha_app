...
from naturallanguageAPI import lambda_handler
...
async def reroute_path(request: Request, call_next):
    # re-route requests from /natural-language/suffix to /suffix
    # ALB listener rules preserve full path when forwarding to ECS, but we only want /ping not /natural-language/ping
...
@app_router.post(
    "/",
    description="Detect entities in natural language query",
    response_model=APIResponse,
    response_description="Natural Language entity types",
    responses={
